...
$con=mysqli_connect("localhost","root","123456","nasasky_com_cn"); 
if (!$con)
  {
...
if (!empty($_POST['index'])&&!empty($_POST['xingbie'])&&!empty($_POST['aihao'])){
